    ...
    <div className="min-h-screen pt-16 md:pt-20">
      ...
      <div className="min-h-[calc(100vh-5rem)]" ref={containerRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center py-12 md:py-0 md:min-h-[calc(100vh-5rem)]">
          ...
          <div className="md:hidden w-full flex flex-col items-center">
            ...
            <div className="w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] relative mb-8">
              <Image
            ...
            {/* Text sections stacked on mobile */}
            <div className="text-center mb-8">
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-[1.1] tracking-tight">
                {'<Hands-On>'} Leader
              </h1>
              <p className="text-base sm:text-lg text-gray-600 mt-4 max-w-sm">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-base md:text-lg text-gray-600 text-center mb-10 md:mb-16 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <Link href="/portfolio" className="group">
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="relative h-48 sm:h-56 flex items-center justify-center p-4 bg-gray-50">
                  <Image
                ...
                <div className="p-5 md:p-6">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">Security Compliance Framework</h3>
                  <p className="text-sm md:text-base text-gray-600">Comprehensive security framework with automated auditing for regulatory compliance across cloud environments.</p>
                </div>
              </div>
            </Link>
            <Link href="/portfolio" className="group">
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-5 md:p-6">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">AI Development Platform</h3>
                  <p className="text-sm md:text-base text-gray-600">End-to-end platform for developing and deploying machine learning models.</p>
                </div>
              </div>
            </Link>
          </div>
          <div className="text-center mt-8 md:mt-12">
            <Link 
              href="/portfolio" 
              className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 border border-transparent text-sm md:text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors"
            >
              View All Projects
              <FaExternalLinkAlt className="ml-2 h-3 w-3 md:h-4 md:w-4" />
            </Link>
          </div>
        </div>
      </section>
